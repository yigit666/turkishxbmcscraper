...
def RECENT(url,name):
        ...
        for thumbnail,url,name in match:
                addDir(name,'http://www.dizi-izleyin.com'+url,4,thumbnail)
def SERIES(url,name):
        req = urllib2.Request(url)
        req.add_header('User-Agent', 'Mozilla/5.0 (Windows; U; Windows NT 5.1; en-GB; rv:1.9.0.3) Gecko/2008092417 Firefox/3.0.3')
        response = urllib2.urlopen(req)
        ...
        for url in page:
                addDir(__language__(30002),'http://www.dizi-izleyin.com'+url,2,'special://home/addons/plugin.video.DİZİİZLE/resources/images/next.png')
