...
def Main_List():
    ...
    dizi_addDir('Tv','http://diziport.com',1,'')

def dizi_categories():
        dizi_addDir(__language__(30011),'search',11,'special://home/addons/plugin.video.diziport/resources/images/search.png')
        dizi_addDir(__language__(30000),'http://diziport.com/index.php?bolum=dizi&obje=default&sayfa=0',12,'special://home/addons/plugin.video.diziport/resources/images/plusone.png')
        dizi_addDir(__language__(30001),'http://diziport.com/',14,'special://home/addons/plugin.video.diziport/resources/images/all.png')
        dizi_addDir(__language__(30012),'http://diziport.com/index.php?bolum=dizi&obje=en_cok_izlenenler',12,'special://home/addons/plugin.video.diziport/resources/images/all.png')
        dizi_addDir(__language__(30004),'http://diziport.com/index.php?bolum=dizi&obje=diziler&tip=belgesel',13,'special://home/addons/plugin.video.diziport/resources/images/yeni.png')
        dizi_addDir(__language__(30007),'http://diziport.com/index.php?bolum=dizi&obje=diziler&tip=asya_dizileri',13,'special://home/addons/plugin.video.diziport/resources/images/main.jpg')
...
def dizi_Recent(url):
        ...
        for url,name in page:
                dizi_addDir(__language__(30006)+' >> '+name,'http://diziport.com/'+url,12,'special://home/addons/plugin.video.diziport/resources/images/next.png')
...
def dizi_Documentary(url):
        ...
        page=re.compile('class=\'current\'><a><b>.+?</b></a></li>\n<li><a href=\'(.+?)\' rel=\'nofollow\'><b>(.+?)</b></a></li>').findall(link)
        for url,name in page:
                dizi_addDir(__language__(30006)+' >> '+name,'http://diziport.com/'+url,13,'special://home/addons/plugin.video.diziport/resources/images/next.png')
        #previous
        page=re.compile('<li><a href=\'(.*?)\' rel=\'nofollow\'><b>(.*?)</b>').findall(link)
        for url,name in page:
                dizi_addDir(__language__(30005)+' >> '+name,'http://diziport.com/'+url,13,'special://home/addons/plugin.video.diziport/resources/images/next.png')
    ...
    #dialog let user choose watch or download...
        ...
        if ret == 1:
                for mname,url in match:
                        a = name+'-'+mname
                        dizi_addDir(a,url,19,'special://home/addons/plugin.video.diziport/resources/images/izle.png')
...
def dizi_mainMenu(url):
        dizi_addDir(__language__(30002),'http://diziport.com/','','special://home/addons/plugin.video.diziport/resources/images/main.jpg')
